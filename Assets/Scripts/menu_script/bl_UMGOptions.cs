...
public class bl_UMGOptions: MonoBehaviour {
    ...
    public Text QualityText = null;        //画面质量
    private int CurrentQuality = 0;        //当前画面质量序号

    public Text AntiStropicText = null;    //抗锯齿
    ...
    public void GameQuality(bool mas)
    {
        ...
        QualitySettings.SetQualityLevel(CurrentQuality);          //设置画面画质
    }
    /// <summary>
    /// 
    /// </summary>
    ...
    {
        CurrentVSC = (b) ? (CurrentVSC + 1) % 3 : (CurrentVSC != 0) ?  (CurrentVSC - 1) % 3 : 2;
